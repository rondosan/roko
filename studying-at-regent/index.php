...
define('CAMPAIGN_ID', "d72892778d194d433bc164c1559a271f");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', 'd6022a05e40c3c206d4f4fbb5331923b');
define('MP_PARAM_NAME', '_hh__sess');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', 'cb7bf88ff50586a39b55d8dce0315beb');
define('CHECK_MCPROXY_VALUE', '4340d647be808ccf3d104a48041daad618c515996396e89fed7bee9c8ada804d');
...
function sendRequest($data, $path = 'index') {
    ...
    $data_to_post = array("cmp"=> CAMPAIGN_ID,"headers" => $data,"adapi" => '2.2', "sv" => '9068.3');

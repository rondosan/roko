...
<head>
    ...
    <!-- Global site tag (gtag.js) - Google Ads: 391659695 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-391659695"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-391659695');
</script>
<!-- Event snippet for Website lead conversion page -->
<script>
  gtag('event', 'conversion', {'send_to': 'AW-391659695/JyrNCPiXwosCEK-B4boB'});
</script>
</head>
